# conda activate allpy39
# pip install --cache-dir D:\.conda\new_pip_cashe moviepy==1.0.3
# с версией moviepy 2.0.2 - Не пошло, т.к. там внутренние зависимости модулей изменились

# python mix_video.py -c zoo.mp4 directed-by-robert.mp4 -o output.mp4
