...
# cd C:\PROJECTS\BASE\CV\OD\supervision_examples\count_people_in_zone
# python ultralytics_example.py --source_weights_path C:\PROJECTS\_Weights_\Yolo8\Yolo8Detection\yolov8x.pt --zone_configuration_path data\multi-zone-config.json --source_video_path market-square.mp4 --target_video_path output_video.mp4
